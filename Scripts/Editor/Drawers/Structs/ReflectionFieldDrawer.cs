...
namespace HJ.Editors
{
    ...
    public class ReflectionFieldDrawer : PropertyDrawer
    {
        ...
        {
            SerializedProperty reflectType = property.FindPropertyRelative("_reflectType");
            SerializedProperty instance = property.FindPropertyRelative("_instance");
            SerializedProperty reflectName = property.FindPropertyRelative("_reflectName");
            SerializedProperty reflectDerived = property.FindPropertyRelative("_reflectDerived");
        ...
        private string[] GetReflectionFields(MonoBehaviour instance, ReflectionField.ReflectionType reflectionType, bool reflectDerived)
        {
            ...
            if (instance != null)
            {
                ...
                {
                    fields.AddRange(from field in instanceType.GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance)
        ...
        //         {
        //             fields.AddRange(from field in instanceType.GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance)
        //                 where (reflectDerived || field.DeclaringType == instanceType) && field.IsDefined(typeof(SerializeField), true)
        //                 select field.Name);
        //         }
        //         else if (reflectionType == ReflectionField.ReflectionType.Property)
        //         {
