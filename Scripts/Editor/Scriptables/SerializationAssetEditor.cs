...
namespace HJ.Editors
{
    ...
    {
        private SerializationAsset Asset;
        private Material UIMaterial;

        private SerializedProperty LevelManagerScene;
        private SerializedProperty MainMenuScene;

        private SerializedProperty DataPath;
        private SerializedProperty SavesPath;
        private SerializedProperty ConfigPath;

        private SerializedProperty InputsFilename;
        private SerializedProperty OptionsFilename;

        private SerializedProperty SaveFolderPrefix;
        private SerializedProperty SaveInfoName;
        private SerializedProperty SaveDataName;
        private SerializedProperty SaveThumbnailName;
        private SerializedProperty SaveExtension;

        private SerializedProperty EncryptionKey;
        private SerializedProperty EncryptSaves;
        private SerializedProperty CreateThumbnails;
        private SerializedProperty SingleSave;
        private SerializedProperty UseSceneNames;
        private SerializedProperty PreviousScenePersistency;
