...
namespace HJ.Runtime
{
    ...
    {
        private readonly SerializationAsset _serializationAsset;

        public SaveGameReader(SerializationAsset serializationAsset)
        {
            _serializationAsset = serializationAsset;
        }
        ...
        public async Task<SavedGameInfo[]> ReadAllSaves()
        {
            ...
            string saveFolderPrefix = _serializationAsset.SaveFolderPrefix;
            string saveInfoPrefix = _serializationAsset.SaveInfoName;
            string saveExtension = _serializationAsset.SaveExtension;
            ...
            if (Directory.Exists(savesPath))
            {
                ...
                foreach (var directoryPath in directories)
                {
                    ...
                    // decrypt saved data
                    string json = await SerializableEncryptor.Decrypt(_serializationAsset, saveInfoPath);
