...
namespace HJ.Runtime
{
    ...
    public static class GameLocalizationE
    {
        ...
        public static string WithGloc(this BindingPath bindingPath, string format)
        {
        ...
        public static void SubscribeGlyphGloc(this BindingPath bindingPath, string key, string format, Action<string> onUpdate)
        {
        ...
        /// <param name="onUpdate">Action when binding path or localization is changed and text is updated.</param>
        public static void SubscribeGlyphGloc(this BindingPath bindingPath, string format, Action<string> onUpdate)
        {
            Regex regex = new Regex(@"\[(.*?)\]");
            Match match = regex.Match(format);
            if (!match.Success) throw new ArgumentNullException("Could not find the gloc key in [] brackets.");
